...
[
  ["アイリーベリー","あいりーべりー","airiberi","profile"],
  ["アイリス","あいりす","airisu","profile"],
  ["アイリッシュ","あいりっしゅ","airisshu","profile"],
  ["アイリプサス","あいりぷさす","airipusasu","profile"],
  ["アイロニー","あいろにー","aironi","profile"],
  ["アインシュリット","あいんしゅりっと","ainshuritto","profile"],
  ["アインソフ","あいんそふ","ainsofu","profile"],
  ["アヴァランチ","あう゛ぁらんち","abuaranchi","profile"],
  ["アヴァンリリィ","あう゛ぁんりりぃ","abuanririi","profile"],
  ["アウィーエフ","あうぃーえふ","auiefu","profile"],
  ["アヴィレックス","あう゛ぃれっくす","abuirekkusu","profile"],
  ["アウェイク","あうぇいく","aueiku","profile"],
  ["アヴェダ","あう゛ぇだ","abueda","profile"],
  ["アヴォイド","あう゛ぉいど","abuoido","profile"],
  ["アウトキャスト","あうときゃすと","autokyasuto","profile"],
  ["アウトドアプロダクツ","あうとどあぷろだくつ","autodoapurodakutsu","profile"],
  ["アダム","あだむ","adamu","profile"],
  ["アダム エ ロペ","あだむ え ろぺ","adamu e rope","profile"],
  ["アダムキメル","あだむきめる","adamukimeru","profile"],
  ["アダワス","あだわす","adawasu","profile"],
  ["アッカ","あっか","akka","profile"],
  ["アッシュ","あっしゅ","asshu","profile"],
  ["アッシュダイヤモンド","あっしゅだいやもんど","asshudaiyamondo","profile"],
  ["アッシュペーフランス","あっしゅぺーふらんす","asshupefuransu","profile"],
  ["アッソブ","あっそぶ","assobu","profile"],
  ["アットラスト","あっとらすと","attorasuto","profile"],
  ["アッパーハイツ","あっぱーはいつ","appahaitsu","profile"],
  ["アップスタート","あっぷすたーと","appusutato","profile"],
  ["アップタイト","あっぷたいと","apputaito","profile"],
  ["アップルバム","あっぷるばむ","appurubamu","profile"],
  ["アツギ","あつぎ","atsugi","profile"],
  ["アッシュ スタンダード","あっしゅ すたんだーど","asshu sutandado","profile"],
  ["アツロウ タヤマ","あつろう たやま","atsuro tayama","profile"],
  ["アティース","あてぃーす","ateisu","profile"],
  ["アテヴァネッサブリューノ","あてう゛ぁねっさぶりゅーの","atebuanessaburyuno","profile"],
  ["アテストーニ","あてすとーに","atesutoni","profile"],
  ["アテナデザイン","あてなでざいん","atenadezain","profile"],
  ["アディアキブラ","あでぃあきぶら","adeiakibura","profile"],
  ["アディアム","あでぃあむ","adeiamu","profile"],
  ["アディクティブ","あでぃくてぃぶ","adeikuteibu","profile"],
  ["アディクト","あでぃくと","adeikuto","profile"],
  ["アディダス","あでぃだす","adeidasu","profile"],
  ["アディダス オリジナルス","あでぃだす おりじなるす","adeidasu orijinarusu","profile"],
  ["アディダスバイジェレミースコット","あでぃだすばいじぇれみーすこっと","adeidasubaijieremisukotto","profile"],
  ["アディダスバイステラマッカートニー","あでぃだすばいすてらまっかーとにー","adeidasubaisuteramakkatoni","profile"],
  ["アディッションアデライデ","あでぃっしょんあでらいで","adeisshonaderaide","profile"],
  ["アデデ","あでで","adede","profile"],
  ["アデュー トリステス","あでゅー とりすてす","adeyu torisutesu","profile"],
  ["アデュートリステス ロワズィール","あでゅーとりすてす ろわずぃーる","adeyutorisutesu rowazuiru","profile"],
  ["アトウ","あとう","ato","profile"],
  ["アトモスガール","あともすがーる","atomosugaru","profile"],
  ["アトモスガールズ","あともすがーるず","atomosugaruzu","profile"],
  ["アトモスフィア","あともすふぃあ","atomosufuia","profile"],
  ["アトランティックスターズ","あとらんてぃっくすたーず","atoranteikkusutazu","profile"],
  ["アトリエ サブ","あとりえ さぶ","atorie sabu","profile"],
  ["アトリエ シックス","あとりえ しっくす","atorie shikkusu","profile"],
  ["アトリエ ドゥ サボン","あとりえ どぅ さぼん","atorie do sabon","profile"],
  ["アトリエブルージュ","あとりえぶるーじゅ","atorieburuju","profile"],
  ["アトリエ ボズ","あとりえ ぼず","atorie bozu","profile"],
  ["アトリエメルカダル","あとりえめるかだる","atoriemerukadaru","profile"],
  ["アドーア","あどーあ","adoa","profile"],
  ["アドニシス","あどにしす","adonishisu","profile"],
  ["アドニスグリーン","あどにすぐりーん","adonisugurin","profile"],
  ["アドバンテージサイクル","あどばんてーじさいくる","adobantejisaikuru","profile"],
  ["アドポーション","あどぽーしょん","adoposhon","profile"],
  ["アドミラル","あどみらる","adomiraru","profile"],
  ["アドリー","あどりー","adori","profile"],
  ["アドルフ","あどるふ","adorufu","profile"],
  ["アナーキックアジャストメント","あなーきっくあじゃすとめんと","anakikkuajasutomento","profile"],
  ["アナイ","あない","anai","profile"],
  ["アナキ","あなき","anaki","profile"],
  ["アナザー エディション","あなざー えでぃしょん","anaza edeishon","profile"],
  ["アナザーヘブン","あなざーへぶん","anazahebun","profile"],
  ["アナスイ","あなすい","anasui","profile"],
  ["アナスイミニ","あなすいみに","anasuimini","profile"],
  ["アナック","あなっく","anakku","profile"],
  ["アナップ","あなっぷ","anappu","profile"],
  ["アナップ ミンピ","あなっぷ みんぴ","anappu mimpi","profile"],
  ["アナップ ラティーナ","あなっぷ らてぃーな","anappu rateina","profile"],
  ["アナディス","あなでぃす","anadeisu","profile"],
  ["アナトミカ","あなとみか","anatomika","profile"],
  ["アナトリエ","あなとりえ","anatorie","profile"],
  ["アナナ","あなな","anana","profile"],
  ["アナログクロージング","あなろぐくろーじんぐ","anarogukurojingu","profile"],
  ["アナログライティング","あなろぐらいてぃんぐ","anaroguraiteingu","profile"],
  ["アニアリ","あにあり","aniari","profile"],
  ["アニータコー","あにーたこー","anitako","profile"],
  ["アネモネ","あねもね","anemone","profile"],
  ["アネロ","あねろ","anero","profile"],
  ["アノーカ","あのーか","anoka","profile"],
  ["アノニムクラフツマンデザイン","あのにむくらふつまんでざいん","anonimukurafutsumandezain","profile"],
  ["アバクロンビーフィッチ","あばくろんびーふぃっち","abakurombifuitchi","profile"],
  ["アバッグオブチップス","あばっぐおぶちっぷす","abagguobuchippusu","profile"],
  ["アフターザレイン","あふたーざれいん","afutazarein","profile"],
  ["アフターベース","あふたーべーす","afutabesu","profile"],
  ["アフタヌーンティー","あふたぬーんてぃー","afutanuntei","profile"],
  ["アフリカタロウ","あふりかたろう","afurikataro","profile"],
  ["アブストライズ","あぶすとらいず","abusutoraizu","profile"],
  ["アブソール","あぶそーる","abusoru","profile"],
  ["アプレ","あぷれ","apure","profile"],
  ["アプレイウィズハッピーエンディング","あぷれいうぃずはっぴーえんでぃんぐ","apureiuizuhappiendeingu","profile"],
  ["アプレジュール","あぷれじゅーる","apurejuru","profile"],
  ["アプレレクール","あぷれれくーる","apurerekuru","profile"],
  ["アプワイザー リッシェ","あぷわいざー りっしぇ","apuwaiza risshie","profile"],
  ["アプワイザーリュクス","あぷわいざーりゅくす","apuwaizaryukusu","profile"],
  ["アベイシングエイプ","あべいしんぐえいぷ","abeishingueipu","profile"],
  ["アベイル","あべいる","abeiru","profile"],
  ["アベックモデレーション","あべっくもでれーしょん","abekkumodereshon","profile"],
  ["アベニールエトワール","あべにーるえとわーる","abeniruetowaru","profile"],
  ["アホープヘンプ","あほーぷへんぷ","ahopuhempu","profile"],
  ["アボンタージュ","あぼんたーじゅ","abontaju","profile"],
  ["アマート","あまーと","amato","profile"],
  ["アマカ","あまか","amaka","profile"],
  ["アマダナ","あまだな","amadana","profile"],
  ["アマベル","あまべる","amaberu","profile"],
  ["アマンアンドシロー","あまんあんどしろー","amanandoshiro","profile"],
  ["アマンダウェイクリー","あまんだうぇいくりー","amandaueikuri","profile"],
  ["アミ","あみ","ami","profile"],
  ["アミアミ","あみあみ","amiami","profile"],
  ["アミウ","あみう","amiu","profile"],
